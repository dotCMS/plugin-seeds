...
This plugin creates an endpoint for the retrieve and save templates. 
...
`GET http://localhost:8080/api/v1/templates?id=fde4c167-edf4-4699-8a3a-0bf155067555`

This GET will recover draw or advance template information

`GET http://localhost:8080/api/v1/templates/plain?id=fde4c167-edf4-4699-8a3a-0bf155067555`

This GET will retrieve just the body as a plain text

`POST http://localhost:8080/api/v1/templates/advance`
`
{

        "body": "<h1>Template test2</h1>",
        "description": "This is the description",
        "id": "d0425271-ebed-41b6-9b00-629c00272553",
        "image": "bfee8f08-a6d1-4fd7-8f70-476e62663eca",
        "siteId": "48190c8c-42c4-46af-8d1a-0cd5db894797",
        "title": "Advance Template 2"
}
`

This is an example about how to create a template
## Authentication
