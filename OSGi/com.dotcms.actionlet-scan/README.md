...
### com.dotmarketing.osgi.actionlet.actionlets.MyActionlet, com.dotmarketing.osgi.actionlet.actionlets.HelloActionlet
...
Instead of using the GenericBundleActivator.registerActionlet method, will use scan both actionlets.
